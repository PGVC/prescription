                ...
                <div class="w-75">
                    <form action="/password/reset" method="POST">
                        ...
                        <div class="form-group mb-3">
                            <input type="email" name="email" class="form-control custom-input" placeholder="E-Mail Address" required>
                        </div>
                        <button type="submit" class="btn btn-danger">Send Password Reset Link</button>
                    </form>
                    <div class="mt-3 text-end">
                        <a href="/login" class="text-light">Already registered? Sign In</a>
                    </div>
                </div>
            </div>
        </div>
