                ...
                <form method="get" action="/patients/save" class="p-3 border rounded">
                   @csrf
                    ...
                    <div class="col">
                        ...
                        <input type="text" id="doctorName" class="form-control" name="doctor_name" required>
                    </div>
                    <div class="col">
                    ...
                    <div class="col">
                        ...
                        <input type="tel" id="pnum" class="form-control" name="pnum" required>
                    </div>
                    <div class="col">
                        <label for="weight">Bussiness Location:</label>
                        <input type="tel" id="b_location" class="form-control" name="b_location">
                    </div>
                    <div class="col">
                        <label for="weight">Location ID:</label>
                        <input type="tel" id="l_id" class="form-control" name="l_id">
                    </div>
                    <div class="col">
